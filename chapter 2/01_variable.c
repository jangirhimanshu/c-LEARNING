...
/*
1) type declaration instructions are 
  int a;
  float b;
  char c;
*/
...
int main()
{
    ...
    int j = i;
    int a = 2, b = 3, c = 4, d = 5; // if in this code we use float i ; <--- this is not valid because we use i variable in int.
